...
PointContourGUIFrame::PointContourGUIFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Notebook1 = new wxNotebook(ScrolledWindow1, ID_NOTEBOOK1, wxPoint(750,20), wxSize(250,630), 0, _T("ID_NOTEBOOK1"));
    ...
    SplitterWindow1->SetSashPosition(700);
    ...
    *(m_openGLView->getPointCloudRenderer()) = m_pcUtils->pcRenderer;
    m_openGLView->pcUtils = m_pcUtils;
