...
PointContourGUIFrame::PointContourGUIFrame(wxWindow* parent,wxWindowID id)
{
    ...
    StaticBoxSizer1 = new wxStaticBoxSizer(wxVERTICAL, ScrolledWindow1, _("Visualization"));
    FlexGridSizer2 = new wxFlexGridSizer(0, 1, 0, 0);
    ShowPoint = new wxCheckBox(ScrolledWindow1, ID_CHECKBOX1, _("show point"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
    ShowPoint->SetValue(false);
    FlexGridSizer2->Add(ShowPoint, 1, wxALL|wxALIGN_LEFT|wxALIGN_TOP, 5);
    HidePointCloud = new wxCheckBox(ScrolledWindow1, ID_CHECKBOX2, _("hide point cloud"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
    HidePointCloud->SetValue(false);
    FlexGridSizer2->Add(HidePointCloud, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer3 = new wxStaticBoxSizer(wxHORIZONTAL, ScrolledWindow1, _("Disc radius"));
    DiscRadius = new wxSlider(ScrolledWindow1, ID_SLIDER1, 50, 0, 100, wxDefaultPosition, wxSize(150,20), 0, wxDefaultValidator, _T("ID_SLIDER1"));
    ...
    ShowHessian = new wxCheckBox(ScrolledWindow1, ID_CHECKBOX3, _("show hessian"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
    ShowHessian->SetValue(false);
    FlexGridSizer2->Add(ShowHessian, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    HessianLength = new wxSlider(ScrolledWindow1, ID_SLIDER2, 50, 0, 100, wxDefaultPosition, wxSize(150,20), 0, wxDefaultValidator, _T("ID_SLIDER2"));
    FlexGridSizer2->Add(HessianLength, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ShowMetric = new wxCheckBox(ScrolledWindow1, ID_CHECKBOX4, _("show metric"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
    ...
    StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, ScrolledWindow1, _("Grid Resolution"));
    FlexGridSizer4 = new wxFlexGridSizer(0, 6, 0, 0);
    StaticText1 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT1, _("x"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
    FlexGridSizer4->Add(StaticText1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    GridResX = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL1, _("128"), wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    FlexGridSizer4->Add(GridResX, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText2 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT2, _("y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    FlexGridSizer4->Add(StaticText2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    GridResY = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL2, _("128"), wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
    FlexGridSizer4->Add(GridResY, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText3 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT3, _("z"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    FlexGridSizer4->Add(StaticText3, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    GridResZ = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL3, _("128"), wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
    ...
    StaticText4 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT4, _("Extra Boarder Size"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
    FlexGridSizer5->Add(StaticText4, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ExtNum = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL4, _("15"), wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
    ...
    StaticText11 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT11, _("A1"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    FlexGridSizer6->Add(StaticText11, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Alpha1 = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL11, _("0.1"), wxDefaultPosition, wxSize(50,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL11"));
    FlexGridSizer6->Add(Alpha1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText6 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT6, _("A2"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    FlexGridSizer6->Add(StaticText6, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    Alpha2 = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL6, _("0.1"), wxDefaultPosition, wxSize(50,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
    FlexGridSizer6->Add(Alpha2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText10 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT10, _("An"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
    FlexGridSizer6->Add(StaticText10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    AlphaN = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL10, _("0.2"), wxDefaultPosition, wxSize(50,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL10"));
    ...
    UpdateParametersButton = new wxButton(ScrolledWindow1, ID_BUTTON1, _("Update"), wxDefaultPosition, wxSize(100,40), 0, wxDefaultValidator, _T("ID_BUTTON1"));
    ...
    StaticBoxSizer5 = new wxStaticBoxSizer(wxVERTICAL, ScrolledWindow1, _("Debug"));
    FlexGridSizer8 = new wxFlexGridSizer(0, 6, 0, 0);
    StaticText7 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT7, _("x"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
    FlexGridSizer8->Add(StaticText7, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    PosX = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL7, wxEmptyString, wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL7"));
    FlexGridSizer8->Add(PosX, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText8 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT8, _("y"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
    FlexGridSizer8->Add(StaticText8, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    PosY = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL8, wxEmptyString, wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL8"));
    FlexGridSizer8->Add(PosY, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticText9 = new wxStaticText(ScrolledWindow1, ID_STATICTEXT9, _("z"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
    FlexGridSizer8->Add(StaticText9, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    PosZ = new wxTextCtrl(ScrolledWindow1, ID_TEXTCTRL9, wxEmptyString, wxDefaultPosition, wxSize(40,30), 0, wxDefaultValidator, _T("ID_TEXTCTRL9"));
    ...
    PrintInfoButton = new wxButton(ScrolledWindow1, ID_BUTTON2, _("Print Info"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
    StaticBoxSizer5->Add(PrintInfoButton, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer1->Add(StaticBoxSizer5, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
